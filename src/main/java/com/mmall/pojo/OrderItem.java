...
public class OrderItem {
    ...
    public OrderItem(Integer userId, Long orderNo, Integer productId, String productName, String productImage, BigDecimal currentUnitPrice, Integer quantity, BigDecimal totalPrice, Date createTime, Date updateTime,Integer id ){
        this.id = id;
        this.userId = userId;
